  ...
  return (
    ...
    >
      <div className="w-2/3 p-6">
        ...
        <button className="p-1.5 hover:text-white hover:bg-brand-primary hover:shadow-lg transition-all rounded mt-6 text-xs text-brand-primaryTextColor border border-brand-primaryTextColor">
